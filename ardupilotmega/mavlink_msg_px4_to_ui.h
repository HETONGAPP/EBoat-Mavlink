...
#define MAVLINK_MSG_ID_PX4_TO_UI 50008
...
typedef struct __mavlink_px4_to_ui_t {
 ...
 float motor2_direction; /*<  Direction of motor 2(0: forward,1:reverse)*/
...
#define MAVLINK_MSG_ID_50008_LEN 33
#define MAVLINK_MSG_ID_50008_MIN_LEN 33

#define MAVLINK_MSG_ID_PX4_TO_UI_CRC 13
#define MAVLINK_MSG_ID_50008_CRC 13
 ...
 * @param motor2_direction  Direction of motor 2(0: forward,1:reverse)
...
static inline uint16_t mavlink_msg_px4_to_ui_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, float motor1_speed, float motor1_direction, float motor2_speed, float motor2_direction, float eboat_speed, float eboat_heading, uint8_t gear)
{
...
{
    return mavlink_msg_px4_to_ui_pack(system_id, component_id, msg, px4_to_ui->timestamp, px4_to_ui->motor1_speed, px4_to_ui->motor1_direction, px4_to_ui->motor2_speed, px4_to_ui->motor2_direction, px4_to_ui->eboat_speed, px4_to_ui->eboat_heading, px4_to_ui->gear);
}
...
{
    return mavlink_msg_px4_to_ui_pack_chan(system_id, component_id, chan, msg, px4_to_ui->timestamp, px4_to_ui->motor1_speed, px4_to_ui->motor1_direction, px4_to_ui->motor2_speed, px4_to_ui->motor2_direction, px4_to_ui->eboat_speed, px4_to_ui->eboat_heading, px4_to_ui->gear);
}
...
{
    return mavlink_msg_px4_to_ui_pack_status(system_id, component_id, _status, msg,  px4_to_ui->timestamp, px4_to_ui->motor1_speed, px4_to_ui->motor1_direction, px4_to_ui->motor2_speed, px4_to_ui->motor2_direction, px4_to_ui->eboat_speed, px4_to_ui->eboat_heading, px4_to_ui->gear);
}
...
static inline void mavlink_msg_px4_to_ui_send(mavlink_channel_t chan, uint64_t timestamp, float motor1_speed, float motor1_direction, float motor2_speed, float motor2_direction, float eboat_speed, float eboat_heading, uint8_t gear)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PX4_TO_UI_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_px4_to_ui_send(chan, px4_to_ui->timestamp, px4_to_ui->motor1_speed, px4_to_ui->motor1_direction, px4_to_ui->motor2_speed, px4_to_ui->motor2_direction, px4_to_ui->eboat_speed, px4_to_ui->eboat_heading, px4_to_ui->gear);
#else
 ...
 */
static inline void mavlink_msg_px4_to_ui_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, float motor1_speed, float motor1_direction, float motor2_speed, float motor2_direction, float eboat_speed, float eboat_heading, uint8_t gear)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return  Direction of motor 2(0: forward,1:reverse)
 */
