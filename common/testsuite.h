...
static void mavlink_test_px4_to_ui(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_px4_to_ui_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.timestamp = packet_in.timestamp;
        packet1.motor1_speed = packet_in.motor1_speed;
        packet1.motor1_direction = packet_in.motor1_direction;
        packet1.motor2_speed = packet_in.motor2_speed;
        packet1.motor2_direction = packet_in.motor2_direction;
    ...
    mavlink_msg_px4_to_ui_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_px4_to_ui_pack(system_id, component_id, &msg , packet1.timestamp , packet1.gear , packet1.motor1_speed , packet1.motor1_direction , packet1.motor2_speed , packet1.motor2_direction , packet1.eboat_speed , packet1.eboat_heading );
    mavlink_msg_px4_to_ui_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_px4_to_ui_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.timestamp , packet1.gear , packet1.motor1_speed , packet1.motor1_direction , packet1.motor2_speed , packet1.motor2_direction , packet1.eboat_speed , packet1.eboat_heading );
    mavlink_msg_px4_to_ui_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_px4_to_ui_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_px4_to_ui_send(MAVLINK_COMM_1 , packet1.timestamp , packet1.gear , packet1.motor1_speed , packet1.motor1_direction , packet1.motor2_speed , packet1.motor2_direction , packet1.eboat_speed , packet1.eboat_heading );
    mavlink_msg_px4_to_ui_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
